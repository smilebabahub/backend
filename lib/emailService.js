    ...
    html: baseTemplate({
      ...
      body: `
        ...
        <p style="font-size:15px;color:${BRAND.textDark};line-height:1.7;margin:0 0 20px;">
          ...
          <strong>20% commission</strong> on every subscription they purchase.
          Vendors who use your code also get a 20% discount — a win for everyone.
        </p>
        ${infoBox([
          ["Your name", name],
          ["Email", email],
          ...
          ["Commission", "20% per referred subscription"],
          ["Vendor discount", "20% off their plan"],
        ])}
