...
const orderSchema = new mongoose.Schema(
  {
    ...
    notes: { type: String, default: "" },
      ...
      escrowReleaseTrigger: {
        type: String,
        enum: ["auto_on_delivery", "buyer_confirms", "vendor_confirms_delivery", "manual"],
      ...
      refundPolicy: {
        type:   { type: String, enum: ["none", "before_dispatch", "vendor_cancel", "window"] },
      ...
      deliveryConfirmedBy:      { type: String, enum: ["buyer", "vendor", "system", "admin"] },
